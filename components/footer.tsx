      ...
      >
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            For more information or to get started, contact our sales team today and unlock the full potential of our cutting-edge sales platform.
            </p>
        ...
        <p className="text-xs text-gray-500">
          &copy; 2024. Pinnacle Commerce. All rights reserved.
        </p>
      </div>
    </footer>
  )
